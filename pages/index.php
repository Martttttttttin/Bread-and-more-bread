...
<section class="hero" id="inicio">
    ...
    <div class="hero__content">
        ...
        <p class="hero__sub">Horneado con amor desde 1987. Pan artesanal que despierta los sentidos y reconforta el alma
            con cada mordisco.</p>
...
<section class="productos" id="productos">
    ...
    <div class="prod-row" data-dir="ltr">
        ...
        <div class="prod-row__info">
            ...
            <p>Corteza crujiente y miga aireada. Nuestra baguette se elabora con masa madre de 24 horas de fermentación
                en frío, logrando ese sabor inconfundible que evoca las mejores boulangeries.</p>
    ...
    <div class="prod-row" data-dir="rtl">
        ...
        <div class="prod-row__info prod-row__info--light">
            ...
            <p>Rústico por fuera, esponjoso por dentro. Este pan de campo recoge la esencia de la panadería rural, con
                una corteza que suena al golpe y un interior que abraza.</p>
            <ul class="prod-row__tags">
    ...
    <div class="prod-row" data-dir="ltr">
        ...
        <div class="prod-row__info">
            ...
            <p>Hojaldrado en 27 capas con mantequilla de calidad extra. Un ritual de tres días: amasado, reposo y
                laminado. El resultado es ese crujido perfecto al primer mordisco.</p>
            <ul class="prod-row__tags">
    ...
    <div class="prod-row" data-dir="rtl">
        ...
        <div class="prod-row__info prod-row__info--light">
            ...
            <p>El clásico de cada mañana, elevado. Nuestra miga tierna y elástica hace que la tostada del desayuno sea
                el mejor momento del día. Sin azúcar añadida, siempre fresco.</p>
            <ul class="prod-row__tags">
...
<section class="contacto" id="contacto">
    ...
    <div class="contacto__inner reveal">
        ...
        <p>Abrimos todos los días desde las 7:00 AM. Ven a sentir el aroma que llena el barrio y llévate un poco de
            nuestra tradición.</p>
